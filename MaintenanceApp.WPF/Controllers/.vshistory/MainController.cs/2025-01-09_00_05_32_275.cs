...
public class MainController
{
    ...
    public static void MangVisitDateBox()
    {
        ...
        SummaryTextBlock.VisitDateBox.Text = "25";
        ...
        SummaryTextBlock.TechnicianComboBox.Background= Brushes.IndianRed;
    ...
    public static void SummaryAsync(string summary ,Brush ForgroundColor)
    {
        ...
        SummaryTextBlock.MainContentControl.Content.GetType().
    }
