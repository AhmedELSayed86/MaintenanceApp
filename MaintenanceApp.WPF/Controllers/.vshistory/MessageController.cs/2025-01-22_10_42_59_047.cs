...
public static class MessageController
{
    ...
    public static async Task SummaryAsync(string summary ,Brush foregroundColor = null ,Brush borderColor = null)
    {
        ...
        if(mainWindow != null)
        {
            await Application.Current.Dispatcher.InvokeAsync(() =>
            {
                ...
                {
                    mainWindow.SummaryTextBlock.Foreground = foregroundColor;
                }
                if(borderColor != null)
                {
                    mainWindow.SummaryBorder.BorderBrush = borderColor;
                }
            });
        }
    }
