...
public class DatabaseHelper : IDatabaseHelper
{
    ...
    private void CreateTables()
    {
        ...
        string createVisitDatasTable = @"CREATE TABLE IF NOT EXISTS VisitDatas ( ID INTEGER PRIMARY KEY, Notification DOUBLE,  VisitDate TEXT, TechnicianCode INTEGER, ServiceDetails TEXT, Implemented TEXT,  Paid TEXT, Unpaid TEXT, Completion TEXT,Collector TEXT, Cost REAL, PaymentRefused INTEGER, DistributionStatus TEXT, AssistantTechnicianCode INTEGER, DefiningTechnicianCode INTEGER, InstallationDate TEXT, ExecutionDuration INTEGER, WarrantyStatus TEXT, UserStatus TEXT,  DiscountRate REAL,  CreatedOn TEXT, ChangeOn TEXT, CreatedBy INTEGER, ChangeBy INTEGER, Notes TEXT);";
        // بيانات قطع الغيار
    ...
    public async Task<bool> CheckIfSapCodeExistsAsync(string tableName ,double sapCode)
    {
        ...
        var command = _connectionString.CreateCommand();
