...
namespace MaintenanceApp.WPF.Helper;
    ...
    private void CreateTables()
    {
        ...
        string createUsersTable = @"CREATE TABLE Users (
                                    ...
                                    ChangeOn DATETIME NOT NULL DEFAULT GETDATE(),
                                    CreatedBy INT NULL,
                                    ChangeBy INT NULL,
    ...
    private void CreateTables()
        {
            ...
            string createSAPDatasTable = @"CREATE TABLE IF NOT EXISTS SAPDatas (
                                           Notification DOUBLE PRIMARY KEY,
