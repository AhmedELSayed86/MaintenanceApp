        ...
        var indexQueries = new List<string>
            {
                ...
                "CREATE INDEX IF NOT EXISTS IX_Users_Role ON User(Role);",
        ...
        var constraintQueries = new List<string>
            {
                ...
                "ALTER TABLE User ADD CONSTRAINT IF NOT EXISTS CK_Users_Role CHECK (Role IN ('Admin', 'Technician', 'Viewer'));"
                // أضف المزيد حسب الحاجة
            };
