...
public class DatabaseHelper : IDatabaseHelper
{
    ...
    private async void AddTestUser()
    {
    ...
    public async Task<bool> AddTestUserAsync()
    {
        try
        {
            ...
            if(!isuser.Any())
            {
                ...
                MessageController.SummaryAsync($"AddTestUserAsync was Completed.");
                await InsertRecordAsync(newUser);
            }
        }
        catch(Exception ex)
        {
            MessageController.SummaryAsync($"Error AddTestUserAsync: {ex.Message}");
