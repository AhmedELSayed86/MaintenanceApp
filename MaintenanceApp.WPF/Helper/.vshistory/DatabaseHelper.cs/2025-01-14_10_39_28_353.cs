...
public class DatabaseHelper : IDatabaseHelper
{
    ...
    private void CreateTables()
    {
        ...
        // بيانات العملاء من الساب
        string createStatusesTable = @"CREATE TABLE IF NOT EXISTS Statuses (  ID INTEGER PRIMARY KEY, Name TEXT, CreatedOn TEXT, ChangeOn TEXT, CreatedBy INTEGER,  ChangeBy INTEGER, Notes TEXT );";
