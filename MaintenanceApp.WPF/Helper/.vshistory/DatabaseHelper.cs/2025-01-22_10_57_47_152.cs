...
public class DatabaseHelper : IDatabaseHelper, IDisposable
{
    ...
    private async Task CreateTablesAsync()
    {
       ...
       await ExecuteNonQuery(connection ,createUsersTable);
     await   ExecuteNonQuery(connection ,createSAPDatasTable);
     await   ExecuteNonQuery(connection ,createStatusesTable);
     await   ExecuteNonQuery(connection ,createVisitDatasTable);
     await   ExecuteNonQuery(connection ,createSparePartsInstalledDatasTable);
     await   ExecuteNonQuery(connection ,createEmployeeDatasTable);
     await   ExecuteNonQuery(connection ,createSparePartDatasTable);
     await   ExecuteNonQuery(connection ,createMyNotesDatasTable);
        await ExecuteNonQuery(connection ,createSparePartsAtTechnicianDatasTable);
    }
