...
public class DatabaseHelper : IDatabaseHelper
{
        ...
        string table1 ,string table2 ,string table3 ,string joinColumn ,string filterValue ,DateTime? createdOnDate = null)
    {
        ...
        {
            // تسجيل الخطأ بدلًا من عرض MessageBox
            Logger.LogError($"Error in GetFilteredLinkedRecordsAsync: {ex.Message}");
            throw; // إعادة رمي الاستثناء للتعامل معه في الطبقات الأعلى
        }
    }
    /// <summary>
