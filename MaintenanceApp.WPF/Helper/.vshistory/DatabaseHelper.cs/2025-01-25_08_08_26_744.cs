...
public class DatabaseHelper : IDatabaseHelper
{
    ...
    public DatabaseHelper()
    {
        ...
        LogInfo("تم تهيئة DatabaseHelper بنجاح.");
    }
    ...
    public async Task AddLogToDatabase(LogEntry log)
    {
        try
        {
            using var connection = CreateConnection();
    ...
    public Task ObservableCollection<LogEntry> LoadLogsFromDatabase()
    {
        ...
        {
            // إعادة القاء الخطأ ليتم التعامل معه في الطبقات الأعلى
            throw new Exception("فشل في قراءة السجلات من قاعدة البيانات" ,ex);
        }
        return logEntries;
    }
