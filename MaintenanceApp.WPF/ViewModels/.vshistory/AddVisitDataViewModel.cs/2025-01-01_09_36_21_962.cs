    ...
    private void ApplyEmployeeFilter()
    {
        ...
        else
        {
            var filtered = EmployeeRecords.Where(e =>
                (!string.IsNullOrEmpty(e.Name) && e.Name.Contains(SearchKeyword ,StringComparison.OrdinalIgnoreCase)) ||
                (!string.IsNullOrEmpty(e.Code?.ToString()) && e.Code.ToString().Contains(SearchKeyword ,StringComparison.OrdinalIgnoreCase)))
                .ToList();
