...
public class AddVisitDataViewModel : BaseViewModel
{
    ...
    private async Task AddTechnicianVisitAsync()
    {
        ...
        try
        {
            ...
            {Notification=SelectedSAPData.Notification,
               VisitDate = SelectedVisitData.VisitDate,  Technician = SelectedEmployee.Code ,
               ...
               UserStatus                  =SelectedVisitData.UserStatus,
                CreatedBy = LoggedInUser,CreatedOn = DateTime.UtcNow
            };
    ...
    {
        if(SelectedSAPData == null) return; else MessageBox.Show("Not Select");
