...
public class AddVisitDataViewModel : BaseViewModel
{
    ...
    private Brush _visitDataBackground = Brushes.Black;
    public Brush VisitDataBackground
    {
        get => _visitDataBackground;
        set
        {
            _visitDataBackground = value;
            OnPropertyChanged(nameof(VisitDataBackground));
        }
    }
    ...
    private async Task ResetErrorColor()
    {
        _technicianTextBoxBackground = Brushes.Black;
        _sAPDataBackground = Brushes.LawnGreen;
        _visitDataBackground = Brushes.Black;
    }
    ...
    private async Task AddTechnicianVisitAsync()
    {
        ...
        if(SelectedVisitData == null)
        {
            VisitDataBackground = Brushes.IndianRed;
