...
public class DistributionToTechniciansViewModel : BaseViewModel
{
    ...
    public DistributionToTechniciansViewModel(IDatabaseHelper databaseHelper)
    {
        ...
        _ = LoadDataAsync();
        LoadEmployeeData();
        _ = LogInfoAsync("تم تهيئة DistributionToTechniciansViewModel بنجاح.");
    }
    ...
    private async Task DistributionToTechniciansAsync()
    {
        ...
        try
        {
            ...
            await LoadDataAsync();
            LoadVisitData();
            await LogInfoAsync("تم التوزيع بنجاح.").ConfigureAwait(false);
            await MessageController.SummaryAsync("تم التوزيع بنجاح.").ConfigureAwait(false);
        }
        catch(Exception ex)
        {
            await LogErrorAsync("حدث خطأ أثناء التوزيع" ,ex);
    ...
    private async void LoadEmployeeData()
    {
        ...
        {
            await LogErrorAsync("خطأ في تحميل بيانات الموظفين" ,ex);
    ...
    private async Task LoadDataAsync()
    {
        ...
        {
            await LogErrorAsync("Error loading data" ,ex);
    ...
    private async void LoadVisitData()
    {
        ...
        {
            await LogErrorAsync($"Error loading visit data: {ex.Message}" ,ex);
            await MessageController.SummaryAsync($"Error loading data: {ex.Message}").ConfigureAwait(false);
        }
    }
    ...
    private async Task AddVisitDataAsync()
    {
        ...
        {
            await LogErrorAsync("Error adding visit data" ,ex);
    ...
    private async Task DeleteVisitDataAsync()
    {
        ...
        {
            await LogErrorAsync("Error deleting visit data" ,ex);
    ...
    private async Task UpdateVisitDataAsync()
    {
        ...
        {
            await LogErrorAsync("Error updating visit data" ,ex);
