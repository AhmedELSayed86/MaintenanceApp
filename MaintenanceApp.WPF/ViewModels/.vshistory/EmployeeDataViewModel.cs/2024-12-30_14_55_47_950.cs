...
public class EmployeeDataViewModel : BaseViewModel
{
    ...
    public EmployeeDataViewModel(IDatabaseHelper databaseHelper)
    {
        ...
        LoadExcelEmployeesCommand = new RelayCommand(_=>  LoadEmployeesFromExcelAsync());
    ...
    private async Task ImportEmployeesFromExcelAsync()
    {
        ...
        await importExcelViewModel.SaveEmployeeDataToDatabaseAsync();
        Summary = importExcelViewModel.Summary;
        _ = LoadDataAsync();
    }

    public     void LoadEmployeesFromExcelAsync()
    {
        EmployeeRecords.Clear();
        ImportExcelViewModel importExcelViewModel = new ImportExcelViewModel(_databaseHelper);
        var employees =  importExcelViewModel.LoadEmployeeDataFromExcelAsync(ExcelHelper.FilePathEmployeeDetails);
     
        foreach(var employee in importExcelViewModel.LoadEmployeeDataFromExcelAsync(ExcelHelper.FilePathEmployeeDetails))
        {
