...
public class EmployeeDataViewModel : BaseViewModel
{
    ...
    private void UpdateFilteredData()
    {
        ...
        EmployeeRecords = filtered; OnPropertyChanged(nameof(EmployeeRecords));
        Summary = $"تم تحميل UpdateFilteredData {ExcelData.Rows.Count} صفوف من ملف Excel.({EmployeeRecords.Count})";
    }
        ...
        try
        {
            ...
            if(ExcelData != null && ExcelData.Rows.Count > 0)
            {
                EmployeeRecords = new ObservableCollection<EmployeeData>(
                    ...
                    })); OnPropertyChanged(nameof(EmployeeRecords));// UpdateFilteredData();
                //EmployeeRecords = ExcelDataList;
