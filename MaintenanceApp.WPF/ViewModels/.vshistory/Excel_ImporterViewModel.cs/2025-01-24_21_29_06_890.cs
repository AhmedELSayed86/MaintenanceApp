...
public class Excel_ImporterViewModel : BaseViewModel
{
    ...
    public Excel_ImporterViewModel(IDatabaseHelper databaseHelper)
    {
        ...
        LoadExcelStatusCommand = new RelayCommand(async  () => await LoadStatusFromExcelAsync());
        ImportStatusCommand = new RelayCommand(async  () => await SaveStatusToDatabaseAsync());
        LoadDataCommand = new RelayCommand(async  () => await LoadDataAsync());
        AddStatusCommand = new RelayCommand(async  () => await AddStatusAsync());
        UpdateStatusCommand = new RelayCommand(async  () => await UpdateStatusAsync());
        DeleteStatusCommand = new RelayCommand(async  () => await DeleteStatusAsync());
