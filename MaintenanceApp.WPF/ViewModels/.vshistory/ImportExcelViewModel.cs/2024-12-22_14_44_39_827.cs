...
public class ImportExcelViewModel : BaseViewModel
{
    ...
    public ImportExcelViewModel()
    {
        ...
        //SaveToDatabaseCommand =new RelayCommand(async o => await SaveToDatabaseAsync(),CanSaveToDatabase()).ObservesProperty(() => ExcelData);
        SaveToDatabaseCommand = new RelayCommand(async o => await SaveToDatabaseAsync() ,o => CanSaveToDatabase()); 
        //CloseCommand = new RelayCommand(o => _onClose());
    }
