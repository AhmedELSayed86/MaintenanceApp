...
namespace MaintenanceApp.WPF.ViewModels
{
    public class LoginViewModel : BaseViewModel
    {
        ...
        public LoginViewModel(IDatabaseHelper databaseHelper)
        {
            ...
            await LogInfoAsync("تم تهيئة LoginViewModel بنجاح.");
        }
        ...
        private void ClosedWindow()
        {
            ...
            MainWindow mainWindow = System.Windows.Application.Current.Windows.OfType<MainWindow>().FirstOrDefault() ?? new MainWindow();
            if(mainWindow != null)
            {
            }
