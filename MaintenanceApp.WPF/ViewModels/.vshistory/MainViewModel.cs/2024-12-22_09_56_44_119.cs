...
public class MainViewModel : BaseViewModel
{
    ...
    {
        PrintWindow printWindow = System.Windows.Application.Current.Windows.OfType<PrintWindow>().FirstOrDefault();
    ...
    {
        ImportExcelWindow employeeWindow = System.Windows.Application.Current.Windows.OfType<ImportExcelWindow>().FirstOrDefault() ?? new ImportExcelWindow();
