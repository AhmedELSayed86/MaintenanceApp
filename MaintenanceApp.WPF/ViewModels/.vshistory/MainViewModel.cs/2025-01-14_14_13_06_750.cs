...
public class MainViewModel : BaseViewModel
{
    ...
    public ICommand OpeneStatusCommand { get; }
    ...
    public MainViewModel()
    {
        ...
        OpeneStatusCommand = new RelayCommand(o => OpeneStatusWindow());
    ...
    private void OpeneStatusWindow()
    {
        StatusWindow StatusWindow = System.Windows.Application.Current.Windows.OfType<StatusWindow>().FirstOrDefault() ?? new StatusWindow();
        mainWindow.MainContentControl.Content = StatusWindow;
    }
