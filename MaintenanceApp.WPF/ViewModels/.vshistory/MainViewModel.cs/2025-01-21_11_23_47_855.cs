...
public class MainViewModel : BaseViewModel
{
    ...
    {
        DistributionToTechniciansWindow addDataWindow = System.Windows.Application.Current.Windows.OfType<DistributionToTechniciansWindow>().FirstOrDefault() ?? new DistributionToTechniciansWindow();
