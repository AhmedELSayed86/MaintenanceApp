...
public class MainViewModel : BaseViewModel
{
    ...
    public MainViewModel()
    {
        ...
        OpenHomeCommand = new RelayCommand(()    => OpenHomeWindow());
        OpeneEmployeeCommand = new RelayCommand(() => OpeneEmployeeWindow());
        OpenPrintCommand = new RelayCommand(()   => OpenPrintWindow());
        OpeneImportExcelNotificationsCommand = new RelayCommand(() => OpeneImportExcelNotificationsWindow());
        OpeneExcel_ImporterCommand = new RelayCommand(() => OpeneExcel_ImporterWindow());
        ApplicationShutdownCommand = new RelayCommand(() => ShutdownApplication());
        OpeneImplementedCommand = new RelayCommand(() => OpeneImplementedWindow());
        OpeneDistributionToTechniciansCommand = new RelayCommand(() => OpeneDistributionToTechniciansWindow());
    ...
    {
        AboutView Window = System.Windows.Application.Current.Windows.OfType<AboutView>().FirstOrDefault() ?? new AboutView();
        mainWindow.MainContentControl.Content = Window; // فتح شاشة "حول" كنافذة منبثقة
    }

    private void OpenPrintWindow()
    {
        PrintWindow Window = System.Windows.Application.Current.Windows.OfType<PrintWindow>().FirstOrDefault() ?? new PrintWindow();
