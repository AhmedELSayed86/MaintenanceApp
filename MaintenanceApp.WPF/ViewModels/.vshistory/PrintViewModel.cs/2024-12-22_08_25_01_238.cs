...
public class PrintViewModel : BaseViewModel
{
    ...
    // Constructor
    public PrintViewModel(IDatabaseHelper databaseHelper ,Action onClose)
    {
        ...
        // Initialize Commands
        LoadCommand = new RelayCommand(async o =>await LoadDataAsync());
        PrintCommand = new RelayCommand( o=> ExportToExcel());
