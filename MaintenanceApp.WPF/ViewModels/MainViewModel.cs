...
public class MainViewModel : INotifyPropertyChanged
{
    ...
    public MainViewModel(IDatabaseHelper databaseHelper )
    {
        ...
        OpeneImportExcelNotificationsCommand = new RelayCommand(_ => OpeneImportExcelNotificationsWindow( databaseHelper));
    ...
    private void OpeneImportExcelNotificationsWindow(IDatabaseHelper databaseHelper)
    {
        ImportExcelWindow addDataWindow = new(databaseHelper);
        addDataWindow.Show();
    }
